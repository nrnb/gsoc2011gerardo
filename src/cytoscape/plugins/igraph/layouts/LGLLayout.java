...
public class LGLLayout extends AbstractIgraphLayout {

    private int     iterNumber            = 150;   // Number of iterations
    ...
    public LGLLayout() {
	super();
	logger = CyLogger.getLogger(LGLLayout.class);
	...
	double maxDelta   = maxDeltaCoefficient;
	...
	return "Igraph Force Directed Layout (for large Graphs)";
    }
